...
def CE_Net_Train():
    ...
    for epoch in range(1, total_epoch + 1):
        ...
        torchvision.utils.save_image(img[0, :, :, :], "test_data/results2/image_"+str(epoch) + ".jpg", nrow=1, padding=2, normalize=True, range=None, scale_each=False, pad_value=0)
        torchvision.utils.save_image(mask[0, :, :, :], "test_data/results2/mask_"+str(epoch) + ".jpg", nrow=1, padding=2, normalize=True, range=None, scale_each=False, pad_value=0)
        torchvision.utils.save_image(pred[0, :, :, :], "test_data/results2/pred_"+str(epoch) + ".jpg", nrow=1, padding=2, normalize=True, range=None, scale_each=False, pad_value=0)
