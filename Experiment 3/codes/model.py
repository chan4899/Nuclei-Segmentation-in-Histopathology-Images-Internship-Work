...
class MaskRCNN():
    ...
    def detect(self, images, verbose=0, mask_threshold=0.5):
        ...
        results = []
        print("length_of_images ", len(images))
        for i, image in enumerate(images):
            ...
            # print(type(final_masks))
            # print("shape_of_final_masks ", final_masks.shape)
            # print(type(results[0]["masks"]))
            # im = Image.fromarray(results[0]["masks"])
            # im.show()
        print("length_of_results ", len(results))
        return results
